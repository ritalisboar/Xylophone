...
class XylophoneButtons: UIView {
    ...
    private func constraintsCButton() {
        ...
        cButton.heightAnchor.constraint(equalToConstant: 110).isActive = true
    }
    ...
    private func constraintsDButton() {
        ...
        dButton.leadingAnchor.constraint(equalTo: leadingAnchor, constant: 15).isActive = true
        dButton.trailingAnchor.constraint(equalTo: trailingAnchor, constant: -15).isActive = true
        dButton.heightAnchor.constraint(equalToConstant: 110).isActive = true
    }
    ...
    private func constraintsEButton() {
        ...
        eButton.leadingAnchor.constraint(equalTo: leadingAnchor, constant: 25).isActive = true
        eButton.trailingAnchor.constraint(equalTo: trailingAnchor, constant: -25).isActive = true
        eButton.heightAnchor.constraint(equalToConstant: 110).isActive = true
    }
    ...
    private func constraintsFButton() {
        ...
        fButton.leadingAnchor.constraint(equalTo: leadingAnchor, constant: 35).isActive = true
        fButton.trailingAnchor.constraint(equalTo: trailingAnchor, constant: -35).isActive = true
        fButton.heightAnchor.constraint(equalToConstant: 110).isActive = true
    }
    ...
    private func constraintsGButton() {
        ...
        gButton.leadingAnchor.constraint(equalTo: leadingAnchor, constant: 45).isActive = true
        gButton.trailingAnchor.constraint(equalTo: trailingAnchor, constant: -45).isActive = true
        gButton.heightAnchor.constraint(equalToConstant: 110).isActive = true
    }
    ...
    private func constraintsAButton() {
        ...
        aButton.leadingAnchor.constraint(equalTo: leadingAnchor, constant: 55).isActive = true
        aButton.trailingAnchor.constraint(equalTo: trailingAnchor, constant: -55).isActive = true
        aButton.heightAnchor.constraint(equalToConstant: 110).isActive = true
    }
    ...
    private func constraintsBButton() {
        ...
        bButton.leadingAnchor.constraint(equalTo: leadingAnchor, constant: 65).isActive = true
        bButton.trailingAnchor.constraint(equalTo: trailingAnchor, constant: -65).isActive = true
        bButton.heightAnchor.constraint(equalToConstant: 110).isActive = true
    }
